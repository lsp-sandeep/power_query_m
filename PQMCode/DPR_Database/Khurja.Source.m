let
    Source = Folder.Files("\\mydata01\02.teamdata\14.ProjectControls&CapabilityCenter\02.InternalReporting\2.4 Flash Reports\2.4.0 Database\1. DPR\2. Khurja\2022\2022-04"),
    FilteredOpenedFiles = Table.SelectRows(Source, each not Text.Contains([Name], "~")),
    FilteredRequiredFile = Table.SelectRows(FilteredOpenedFiles, each ([Name] = "2022-04_Khurja_DPR_Database.xlsx")),
