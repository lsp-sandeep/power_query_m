let
    Source = Buxar,
    #"Filtered Rows" = Table.SelectRows(Source, each ([Unit] = "Unit-01")),
    ...
    #"Renamed Columns2" = Table.RenameColumns(Custom2,{{"Month Name", "Parameter"}, {"01-01-2022", "01-01-2022_2"}}),
    #"Added Conditional Column" = Table.AddColumn(#"Renamed Columns2", "01-01-2022", each if ([#"01-01-2022_1"] = null or [#"01-01-2022_1"] = 0) then [#"01-01-2022_2"] else [#"01-01-2022_1"]),
    #"Removed Columns2" = Table.RemoveColumns(#"Added Conditional Column",{"01-01-2022_2", "01-01-2022_1"})
in
    #"Removed Columns2"